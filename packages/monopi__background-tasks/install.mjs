...
export const PACKAGE_NAME = "@monopi/background-tasks";
...
Usage:
  npx @monopi/background-tasks            Install globally
  npx @monopi/background-tasks --local    Install into project .pi/settings.json
  npx @monopi/background-tasks --remove   Remove from pi
	...
	if (opts.remove) {
		log(
			result.status === "already-removed"
				? "\n✅ @monopi/background-tasks is already absent from pi."
				: "\n✅ Removed @monopi/background-tasks from pi.",
		);
	} else {
		log(
			result.status === "already-installed"
				? "\n✅ @monopi/background-tasks is already installed in pi."
				: "\n✅ Installed @monopi/background-tasks into pi. Restart pi to load it.",
		);
	}
