...
export const messages: Record<Locale, Record<string, string>> = {
	en: {
		...
		"confirm.piManual": "Run manually: npm install -g @earendil-works/pi-coding-agent",
	...
	fr: {
		...
		"confirm.piManual": "Exécutez manuellement : npm install -g @earendil-works/pi-coding-agent",
