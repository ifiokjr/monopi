	...
	return (
		<div className="space-y-12">
			...
			<div className="text-center space-y-4 pt-8">
				...
				<h1 className="text-4xl font-bold text-zinc-50">monopi</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				<FeatureCard icon={<Puzzle className="h-6 w-6" />} title="Extensions" to="/04-extensions" />
				<FeatureCard
			...
			<div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
				...
				<div className="space-y-3">
					<div>
						<p className="text-sm text-zinc-400 mb-1.5">Install the full monopi extension suite:</p>
			...
			<div className="flex flex-wrap gap-4 justify-center text-sm">
				<a href="https://github.com/ifiokjr/monopi" className="text-zinc-400 hover:text-pi-emerald transition-colors">
					GitHub →
				</a>
