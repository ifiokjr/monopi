...
Shared types, registries, icons, and i18n helpers for monopi packages.

## What this package is for

`@monopi/core` is an internal library used by other packages in this monorepo. It provides common building blocks for the CLI and other compiled packages.

## Typical consumers

- `@monopi/cli`
- other first-party monopi packages that need shared registries or presentation helpers
...
pnpm --filter @monopi/core typecheck
```
