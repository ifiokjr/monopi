...
| Package                    | Role                                       |
| -------------------------- | ------------------------------------------ |
| `@monopi/web-server`       | The server this client connects to         |
| `@monopi/web-remote`       | Pi extension that starts the remote server |
| `@monopi/remote-tailscale` | Secure remote sharing via Tailscale        |
