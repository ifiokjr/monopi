...
| Package                    | Role                                                            |
| -------------------------- | --------------------------------------------------------------- |
| `@monopi/web-client`       | Client library that connects to this server                     |
| `@monopi/web-remote`       | Pi extension that wires this server into pi's `/remote` command |
| `@monopi/remote-tailscale` | Tailscale tunnel integration for secure remote access           |
